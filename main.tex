...
\begin{cv}{%
  ...
  % Phone number(s)
  \ProfileInfo{phone}{+353 087 785 5487}
  ...
  \Description{%
    ...
    C/C++ and Python programming languages. He has experience with Java,
...
%-------------------------------------------------------------------------------
  ...
  \Description{%
    ...
    pricing, and internal processes automation which combined add approximately
    R\$ 10 mi.  in revenue. Moreover contribute with efforts to keep solutions

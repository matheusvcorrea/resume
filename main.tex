...
% Work entry for the Experience section
...
% Entries to mark a subsection often followed by a \Description
...
\begin{cv}{%
  ...
  \ProfileInfo{phone}{\(+55\ 11\ 99174\ 8484\)}

  \vspace{.5em}

  % Goal heading, could be used for a quotation or short profile instead
  \noindent\spacedlowsmallcaps{\textbf{SUMMARY}}\vspace{.5em}
...
%-------------------------------------------------------------------------------
  ...
  \noindent\spacedlowsmallcaps{\textbf{EXPERIENCE}}\vspace{.5em}
  ...
  \Description{%
    ...
    \item Machine learning engineer on AWS SageMaker -- data acquisition,
  ...
  % \MarginText{More Experience}

  \WorkEntry{2017}{Intern at Universidade Federal do Paraná} \bullet \space \WorkEntry{2013}{Freelance E-commerce Developer}\vspace{.5em}
  
%-------------------------------------------------------------------------------
%	EDUCATION
%-------------------------------------------------------------------------------

  \noindent\spacedlowsmallcaps{\textbf{EDUCATION}}\vspace{.5em}
